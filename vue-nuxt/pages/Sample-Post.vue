<template>
    <div class="post">
        <!-- Banner -->
        <main-banner banner="/img/post-bg.jpg"
                ...
                <div class="row">
                    <div class="col-lg-8 col-md-10 mx-auto">
                        ...
                        <blockquote class="blockquote">The dreams of yesterday are the hopes of today and the reality of
                            tomorrow. Science has not yet mastered prophecy. We predict too much for the next year and
...
<script>
    export default {
        data() {
            return {
                subheading: 'Problems look mighty small from 150 miles up Posted by Start Bootstrap on August 24, 2019'
            }
        }
    }
</script>
